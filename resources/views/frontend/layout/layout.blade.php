...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/css/style.css') }}?v=21">
    <link rel="stylesheet" href="{{ asset('frontend/css/elements.css') }}?v=20">
    
    @if(app()->getLocale()=='ar')
    <link rel="stylesheet" href="{{asset('frontend/css/arabic.css')}}?v=14" />
    @endif
