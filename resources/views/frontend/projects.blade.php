...
@section('content')
    ...
    <div class="collection">
        ...
        <div class="filters" style="">
            <div class="filter">
                <select class="filterDpd filter_project_country ABCDiatypeMedium tiny" style="width:115px;">    
            ...
            <div class="filter">
                <select class="filterDpd filter_project_category ABCDiatypeMedium tiny" style="width:115px;">
            ...
            <div class="filter">
                <select class="filterDpd filter_project_program_year ABCDiatypeMedium tiny" style="width:115px;">
            ...
            <div class="filter">
                <select class="filterDpd filter_project_program ABCDiatypeMedium tiny" style="width:115px;">
            ...
            <div class="sort">
                <select class="filterDpd sortDpd ABCDiatypeMedium tiny" id="sortDpd">
