...
<style>
    ...
    .diamond-circle-donate-shape:hover {
        fill: {{ $hover_bg_color }};
    }
...
<div class="container">
    <div class="diamond-circle-donate-button-wrapper">
        <svg width="308" height="308" viewBox="0 0 308 308" fill="none" xmlns="http://www.w3.org/2000/svg" class="diamond-circle-donate-button-svg">
            ...
            <!-- Text inside -->
            <text class="diamond-circle-donate-text medium black ABCDiatypeMedium" x="154" y="168" fill="white" text-anchor="middle">{{ $value }}</text>
        </svg>
    </div>
</div>
