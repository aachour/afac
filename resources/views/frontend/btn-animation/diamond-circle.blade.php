...
<style>
    ...
    .diamond-circle-donate-button-svg:hover .diamond-circle-donate-text {
        fill: {{ $hover_text_color }};
    }

    .diamond-circle-donate-button-svg:hover .diamond-circle-donate-shape {
        fill: {{ $hover_bg_color }};
    }
...
<div class="container">
    <div class="diamond-circle-donate-button-wrapper">
        <svg width="250" height="250" viewBox="0 0 308 308" fill="none" xmlns="http://www.w3.org/2000/svg" class="diamond-circle-donate-button-svg">
