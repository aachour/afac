...
<div class="container">
    <div class="circle-diamond-donate-button-wrapper">
        <svg width="200" height="200" viewBox="0 0 308 308" fill="none" xmlns="http://www.w3.org/2000/svg" class="circle-diamond-donate-button-svg">
            ...
            <!-- Text inside -->
            <text class="circle-diamond-donate-text small ABCDiatypeMedium" x="154" y="168" text-anchor="middle">{{ app()->getLocale() == 'en' ? $value : $value_arabic }}</text>
        </svg>
    </div>
</div>
