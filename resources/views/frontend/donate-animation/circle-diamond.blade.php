...
<div class="container">
    <div class="circle-diamond-donate-button-wrapper">
        <svg width="308" height="308" viewBox="0 0 308 308" fill="none" xmlns="http://www.w3.org/2000/svg" class="circle-diamond-donate-button-svg">
            ...
            <!-- Text inside -->
            <text class="circle-diamond-donate-text" x="154" y="168" fill="white" font-family="Arial, sans-serif" font-size="24" font-weight="bold" text-anchor="middle">Donate</text>
        </svg>
    </div>
</div>
