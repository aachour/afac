    ...
    <div>
        ...
        <script>
            ...
            function saveAccordionEntry() {
                ...
                // Walk up from the editor element to find *this* component's wire:id,
                // not the first wire:id on the page (which could be a navbar component).
